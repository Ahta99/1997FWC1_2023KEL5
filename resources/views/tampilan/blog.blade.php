        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
					...
					<li>
                        <a href="/tampilan/contact">Login</a>
                    </li>
					<li>
                        <a href="/tampilan/contact">Pemasangan</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    <hr>
                    <h2 class="intro-text text-center">BERITA
                        <strong>PLN</strong>
                    </h2>
                    <hr>
                </div>
			@foreach($layanan as $data)
                <div class="col-lg-12 text-center">
                    <img class="img-responsive img-border img-full" src="/component/img/{{$data->Gambar_Konten}}" alt="">
                    <h2>{{$data->Layanan}}
                        <br>
                        <small>October 13, 2013</small>
                    </h2>
                    <p>{!!substr($data->Konten,0,250)!!}...</p>
                    <a href="/read/{{$data->id}}" class="btn btn-default btn-lg">Read More</a>
                    <hr>
                </div>
			@endforeach
